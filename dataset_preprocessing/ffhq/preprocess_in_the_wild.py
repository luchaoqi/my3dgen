...
# this will output the face detections in the indir/detections folder 
# ! if multiple faces, take the biggest face
...
# run Deep3DFaceRecon
# this will output the 3D face reconstruction in the Deep3DFaceRecon_pytorch/checkpoints/pretrained/results folder
...
# ! this will output cameras.json which is needed for inversion/PTI in the future
...
# this will mirror the face, note the file output is saved under /dataset_preprocessing/ffhq including dataset.json
